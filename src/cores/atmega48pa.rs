...
impl EEARH {
    pub const EEAR8: RegisterBits<Self> = RegisterBits::new(0x1);
    pub const EEAR80: RegisterBits<Self> = RegisterBits::new(1<<0);

    pub const EEAR9: RegisterBits<Self> = RegisterBits::new(0x2);
    pub const EEAR90: RegisterBits<Self> = RegisterBits::new(1<<1);
