...
impl UEBCLX {
    pub const BYCT: RegisterBits<Self> = RegisterBits::new(0xff);
    pub const BYCT0: RegisterBits<Self> = RegisterBits::new(1<<0);
    pub const BYCT1: RegisterBits<Self> = RegisterBits::new(1<<1);
    pub const BYCT2: RegisterBits<Self> = RegisterBits::new(1<<2);
    pub const BYCT3: RegisterBits<Self> = RegisterBits::new(1<<3);
    pub const BYCT4: RegisterBits<Self> = RegisterBits::new(1<<4);
    pub const BYCT5: RegisterBits<Self> = RegisterBits::new(1<<5);
    pub const BYCT6: RegisterBits<Self> = RegisterBits::new(1<<6);
    pub const BYCT7: RegisterBits<Self> = RegisterBits::new(1<<7);
...
impl TC4H {
    pub const TC4: RegisterBits<Self> = RegisterBits::new(0x7);
    pub const TC40: RegisterBits<Self> = RegisterBits::new(1<<0);
    pub const TC41: RegisterBits<Self> = RegisterBits::new(1<<1);
    pub const TC42: RegisterBits<Self> = RegisterBits::new(1<<2);
...
impl OCR4D {
    pub const OCR4D: RegisterBits<Self> = RegisterBits::new(0xff);
    pub const OCR4D0: RegisterBits<Self> = RegisterBits::new(1<<0);
    pub const OCR4D1: RegisterBits<Self> = RegisterBits::new(1<<1);
    pub const OCR4D2: RegisterBits<Self> = RegisterBits::new(1<<2);
    pub const OCR4D3: RegisterBits<Self> = RegisterBits::new(1<<3);
    pub const OCR4D4: RegisterBits<Self> = RegisterBits::new(1<<4);
    pub const OCR4D5: RegisterBits<Self> = RegisterBits::new(1<<5);
    pub const OCR4D6: RegisterBits<Self> = RegisterBits::new(1<<6);
    pub const OCR4D7: RegisterBits<Self> = RegisterBits::new(1<<7);
...
impl OCR4A {
    pub const OCR4A: RegisterBits<Self> = RegisterBits::new(0xff);
    pub const OCR4A0: RegisterBits<Self> = RegisterBits::new(1<<0);
    pub const OCR4A1: RegisterBits<Self> = RegisterBits::new(1<<1);
    pub const OCR4A2: RegisterBits<Self> = RegisterBits::new(1<<2);
    pub const OCR4A3: RegisterBits<Self> = RegisterBits::new(1<<3);
    pub const OCR4A4: RegisterBits<Self> = RegisterBits::new(1<<4);
    pub const OCR4A5: RegisterBits<Self> = RegisterBits::new(1<<5);
    pub const OCR4A6: RegisterBits<Self> = RegisterBits::new(1<<6);
    pub const OCR4A7: RegisterBits<Self> = RegisterBits::new(1<<7);
...
impl OCR3B {
    pub const OCR3B: RegisterBits<Self> = RegisterBits::new(0xffff);
    pub const OCR3B0: RegisterBits<Self> = RegisterBits::new(1<<0);
    pub const OCR3B1: RegisterBits<Self> = RegisterBits::new(1<<1);
    pub const OCR3B2: RegisterBits<Self> = RegisterBits::new(1<<2);
    pub const OCR3B3: RegisterBits<Self> = RegisterBits::new(1<<3);
    pub const OCR3B4: RegisterBits<Self> = RegisterBits::new(1<<4);
    pub const OCR3B5: RegisterBits<Self> = RegisterBits::new(1<<5);
    pub const OCR3B6: RegisterBits<Self> = RegisterBits::new(1<<6);
    pub const OCR3B7: RegisterBits<Self> = RegisterBits::new(1<<7);
    pub const OCR3B8: RegisterBits<Self> = RegisterBits::new(1<<8);
    pub const OCR3B9: RegisterBits<Self> = RegisterBits::new(1<<9);
    pub const OCR3B10: RegisterBits<Self> = RegisterBits::new(1<<10);
    pub const OCR3B11: RegisterBits<Self> = RegisterBits::new(1<<11);
    pub const OCR3B12: RegisterBits<Self> = RegisterBits::new(1<<12);
    pub const OCR3B13: RegisterBits<Self> = RegisterBits::new(1<<13);
    pub const OCR3B14: RegisterBits<Self> = RegisterBits::new(1<<14);
...
impl TCNT3 {
    pub const TCNT3: RegisterBits<Self> = RegisterBits::new(0xffff);
    pub const TCNT30: RegisterBits<Self> = RegisterBits::new(1<<0);
    pub const TCNT31: RegisterBits<Self> = RegisterBits::new(1<<1);
    pub const TCNT32: RegisterBits<Self> = RegisterBits::new(1<<2);
    pub const TCNT33: RegisterBits<Self> = RegisterBits::new(1<<3);
    pub const TCNT34: RegisterBits<Self> = RegisterBits::new(1<<4);
    pub const TCNT35: RegisterBits<Self> = RegisterBits::new(1<<5);
    pub const TCNT36: RegisterBits<Self> = RegisterBits::new(1<<6);
    pub const TCNT37: RegisterBits<Self> = RegisterBits::new(1<<7);
    pub const TCNT38: RegisterBits<Self> = RegisterBits::new(1<<8);
    pub const TCNT39: RegisterBits<Self> = RegisterBits::new(1<<9);
    pub const TCNT310: RegisterBits<Self> = RegisterBits::new(1<<10);
    pub const TCNT311: RegisterBits<Self> = RegisterBits::new(1<<11);
    pub const TCNT312: RegisterBits<Self> = RegisterBits::new(1<<12);
    pub const TCNT313: RegisterBits<Self> = RegisterBits::new(1<<13);
    pub const TCNT314: RegisterBits<Self> = RegisterBits::new(1<<14);
...
impl UDR1 {
    pub const UDR1: RegisterBits<Self> = RegisterBits::new(0xff);
    pub const UDR10: RegisterBits<Self> = RegisterBits::new(1<<0);
    pub const UDR11: RegisterBits<Self> = RegisterBits::new(1<<1);
    pub const UDR12: RegisterBits<Self> = RegisterBits::new(1<<2);
    pub const UDR13: RegisterBits<Self> = RegisterBits::new(1<<3);
    pub const UDR14: RegisterBits<Self> = RegisterBits::new(1<<4);
    pub const UDR15: RegisterBits<Self> = RegisterBits::new(1<<5);
    pub const UDR16: RegisterBits<Self> = RegisterBits::new(1<<6);
    pub const UDR17: RegisterBits<Self> = RegisterBits::new(1<<7);
...
impl OCR3C {
    pub const OCR3C: RegisterBits<Self> = RegisterBits::new(0xffff);
    pub const OCR3C0: RegisterBits<Self> = RegisterBits::new(1<<0);
    pub const OCR3C1: RegisterBits<Self> = RegisterBits::new(1<<1);
    pub const OCR3C2: RegisterBits<Self> = RegisterBits::new(1<<2);
    pub const OCR3C3: RegisterBits<Self> = RegisterBits::new(1<<3);
    pub const OCR3C4: RegisterBits<Self> = RegisterBits::new(1<<4);
    pub const OCR3C5: RegisterBits<Self> = RegisterBits::new(1<<5);
    pub const OCR3C6: RegisterBits<Self> = RegisterBits::new(1<<6);
    pub const OCR3C7: RegisterBits<Self> = RegisterBits::new(1<<7);
    pub const OCR3C8: RegisterBits<Self> = RegisterBits::new(1<<8);
    pub const OCR3C9: RegisterBits<Self> = RegisterBits::new(1<<9);
    pub const OCR3C10: RegisterBits<Self> = RegisterBits::new(1<<10);
    pub const OCR3C11: RegisterBits<Self> = RegisterBits::new(1<<11);
    pub const OCR3C12: RegisterBits<Self> = RegisterBits::new(1<<12);
    pub const OCR3C13: RegisterBits<Self> = RegisterBits::new(1<<13);
    pub const OCR3C14: RegisterBits<Self> = RegisterBits::new(1<<14);
...
impl UENUM {
    pub const UENUM: RegisterBits<Self> = RegisterBits::new(0x7);
    pub const UENUM0: RegisterBits<Self> = RegisterBits::new(1<<0);
    pub const UENUM1: RegisterBits<Self> = RegisterBits::new(1<<1);
    pub const UENUM2: RegisterBits<Self> = RegisterBits::new(1<<2);
...
impl ICR3 {
    pub const ICR3: RegisterBits<Self> = RegisterBits::new(0xffff);
    pub const ICR30: RegisterBits<Self> = RegisterBits::new(1<<0);
    pub const ICR31: RegisterBits<Self> = RegisterBits::new(1<<1);
    pub const ICR32: RegisterBits<Self> = RegisterBits::new(1<<2);
    pub const ICR33: RegisterBits<Self> = RegisterBits::new(1<<3);
    pub const ICR34: RegisterBits<Self> = RegisterBits::new(1<<4);
    pub const ICR35: RegisterBits<Self> = RegisterBits::new(1<<5);
    pub const ICR36: RegisterBits<Self> = RegisterBits::new(1<<6);
    pub const ICR37: RegisterBits<Self> = RegisterBits::new(1<<7);
    pub const ICR38: RegisterBits<Self> = RegisterBits::new(1<<8);
    pub const ICR39: RegisterBits<Self> = RegisterBits::new(1<<9);
    pub const ICR310: RegisterBits<Self> = RegisterBits::new(1<<10);
    pub const ICR311: RegisterBits<Self> = RegisterBits::new(1<<11);
    pub const ICR312: RegisterBits<Self> = RegisterBits::new(1<<12);
    pub const ICR313: RegisterBits<Self> = RegisterBits::new(1<<13);
    pub const ICR314: RegisterBits<Self> = RegisterBits::new(1<<14);
...
impl OCR3A {
    pub const OCR3A: RegisterBits<Self> = RegisterBits::new(0xffff);
    pub const OCR3A0: RegisterBits<Self> = RegisterBits::new(1<<0);
    pub const OCR3A1: RegisterBits<Self> = RegisterBits::new(1<<1);
    pub const OCR3A2: RegisterBits<Self> = RegisterBits::new(1<<2);
    pub const OCR3A3: RegisterBits<Self> = RegisterBits::new(1<<3);
    pub const OCR3A4: RegisterBits<Self> = RegisterBits::new(1<<4);
    pub const OCR3A5: RegisterBits<Self> = RegisterBits::new(1<<5);
    pub const OCR3A6: RegisterBits<Self> = RegisterBits::new(1<<6);
    pub const OCR3A7: RegisterBits<Self> = RegisterBits::new(1<<7);
    pub const OCR3A8: RegisterBits<Self> = RegisterBits::new(1<<8);
    pub const OCR3A9: RegisterBits<Self> = RegisterBits::new(1<<9);
    pub const OCR3A10: RegisterBits<Self> = RegisterBits::new(1<<10);
    pub const OCR3A11: RegisterBits<Self> = RegisterBits::new(1<<11);
    pub const OCR3A12: RegisterBits<Self> = RegisterBits::new(1<<12);
    pub const OCR3A13: RegisterBits<Self> = RegisterBits::new(1<<13);
    pub const OCR3A14: RegisterBits<Self> = RegisterBits::new(1<<14);
...
impl OCR4B {
    pub const OCR4B: RegisterBits<Self> = RegisterBits::new(0xff);
    pub const OCR4B0: RegisterBits<Self> = RegisterBits::new(1<<0);
    pub const OCR4B1: RegisterBits<Self> = RegisterBits::new(1<<1);
    pub const OCR4B2: RegisterBits<Self> = RegisterBits::new(1<<2);
    pub const OCR4B3: RegisterBits<Self> = RegisterBits::new(1<<3);
    pub const OCR4B4: RegisterBits<Self> = RegisterBits::new(1<<4);
    pub const OCR4B5: RegisterBits<Self> = RegisterBits::new(1<<5);
    pub const OCR4B6: RegisterBits<Self> = RegisterBits::new(1<<6);
    pub const OCR4B7: RegisterBits<Self> = RegisterBits::new(1<<7);
...
impl OCR1C {
    pub const OCR1C: RegisterBits<Self> = RegisterBits::new(0xffff);
    pub const OCR1C0: RegisterBits<Self> = RegisterBits::new(1<<0);
    pub const OCR1C1: RegisterBits<Self> = RegisterBits::new(1<<1);
    pub const OCR1C2: RegisterBits<Self> = RegisterBits::new(1<<2);
    pub const OCR1C3: RegisterBits<Self> = RegisterBits::new(1<<3);
    pub const OCR1C4: RegisterBits<Self> = RegisterBits::new(1<<4);
    pub const OCR1C5: RegisterBits<Self> = RegisterBits::new(1<<5);
    pub const OCR1C6: RegisterBits<Self> = RegisterBits::new(1<<6);
    pub const OCR1C7: RegisterBits<Self> = RegisterBits::new(1<<7);
    pub const OCR1C8: RegisterBits<Self> = RegisterBits::new(1<<8);
    pub const OCR1C9: RegisterBits<Self> = RegisterBits::new(1<<9);
    pub const OCR1C10: RegisterBits<Self> = RegisterBits::new(1<<10);
    pub const OCR1C11: RegisterBits<Self> = RegisterBits::new(1<<11);
    pub const OCR1C12: RegisterBits<Self> = RegisterBits::new(1<<12);
    pub const OCR1C13: RegisterBits<Self> = RegisterBits::new(1<<13);
    pub const OCR1C14: RegisterBits<Self> = RegisterBits::new(1<<14);
...
impl EEAR {
    pub const EEAR: RegisterBits<Self> = RegisterBits::new(0xfff);
    ...
    pub const EEAR10: RegisterBits<Self> = RegisterBits::new(1<<10);
    pub const EEAR11: RegisterBits<Self> = RegisterBits::new(1<<11);
...
impl TCNT4 {
    pub const TC4: RegisterBits<Self> = RegisterBits::new(0xff);
    pub const TC40: RegisterBits<Self> = RegisterBits::new(1<<0);
    pub const TC41: RegisterBits<Self> = RegisterBits::new(1<<1);
    pub const TC42: RegisterBits<Self> = RegisterBits::new(1<<2);
    pub const TC43: RegisterBits<Self> = RegisterBits::new(1<<3);
    pub const TC44: RegisterBits<Self> = RegisterBits::new(1<<4);
    pub const TC45: RegisterBits<Self> = RegisterBits::new(1<<5);
    pub const TC46: RegisterBits<Self> = RegisterBits::new(1<<6);
    pub const TC47: RegisterBits<Self> = RegisterBits::new(1<<7);
...
impl ADCSRB {
    ...
    pub const ADTS: RegisterBits<Self> = RegisterBits::new(0xf);
    ...
    pub const ADTS3: RegisterBits<Self> = RegisterBits::new(1<<3);
...
impl OCR4C {
    pub const OCR4C: RegisterBits<Self> = RegisterBits::new(0xff);
    pub const OCR4C0: RegisterBits<Self> = RegisterBits::new(1<<0);
    pub const OCR4C1: RegisterBits<Self> = RegisterBits::new(1<<1);
    pub const OCR4C2: RegisterBits<Self> = RegisterBits::new(1<<2);
    pub const OCR4C3: RegisterBits<Self> = RegisterBits::new(1<<3);
    pub const OCR4C4: RegisterBits<Self> = RegisterBits::new(1<<4);
    pub const OCR4C5: RegisterBits<Self> = RegisterBits::new(1<<5);
    pub const OCR4C6: RegisterBits<Self> = RegisterBits::new(1<<6);
    pub const OCR4C7: RegisterBits<Self> = RegisterBits::new(1<<7);
...
impl UEINT {
    pub const EPINT: RegisterBits<Self> = RegisterBits::new(0x7f);
    pub const EPINT0: RegisterBits<Self> = RegisterBits::new(1<<0);
    pub const EPINT1: RegisterBits<Self> = RegisterBits::new(1<<1);
    pub const EPINT2: RegisterBits<Self> = RegisterBits::new(1<<2);
    pub const EPINT3: RegisterBits<Self> = RegisterBits::new(1<<3);
    pub const EPINT4: RegisterBits<Self> = RegisterBits::new(1<<4);
    pub const EPINT5: RegisterBits<Self> = RegisterBits::new(1<<5);
    pub const EPINT6: RegisterBits<Self> = RegisterBits::new(1<<6);
...
impl UEBCHX {
    pub const BYCT: RegisterBits<Self> = RegisterBits::new(0x7);
    pub const BYCT0: RegisterBits<Self> = RegisterBits::new(1<<0);
    pub const BYCT1: RegisterBits<Self> = RegisterBits::new(1<<1);
    pub const BYCT2: RegisterBits<Self> = RegisterBits::new(1<<2);
...
impl UDFNUM {
    pub const FNUM: RegisterBits<Self> = RegisterBits::new(0x7ff);
    pub const FNUM0: RegisterBits<Self> = RegisterBits::new(1<<0);
    pub const FNUM1: RegisterBits<Self> = RegisterBits::new(1<<1);
    pub const FNUM2: RegisterBits<Self> = RegisterBits::new(1<<2);
    pub const FNUM3: RegisterBits<Self> = RegisterBits::new(1<<3);
    pub const FNUM4: RegisterBits<Self> = RegisterBits::new(1<<4);
    pub const FNUM5: RegisterBits<Self> = RegisterBits::new(1<<5);
    pub const FNUM6: RegisterBits<Self> = RegisterBits::new(1<<6);
    pub const FNUM7: RegisterBits<Self> = RegisterBits::new(1<<7);
    pub const FNUM8: RegisterBits<Self> = RegisterBits::new(1<<8);
    pub const FNUM9: RegisterBits<Self> = RegisterBits::new(1<<9);
    pub const FNUM10: RegisterBits<Self> = RegisterBits::new(1<<10);
